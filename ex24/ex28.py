...
print("14.not(1==1 and 0!=1) = %s" %(not ((10==1)or (1000==1000))))
print("15.not(1!=10 or 3==4) = %s" %(not ((1 !=10)or (3==4))))
print("16.not('testing'=='testing' and 'Zed'=='cool guy') =%s "
      %(not(('testing' == 'testing')and ('Zed'=='cool guy'))))
print("18.1==1 and not('testing'==1 or 1==0) = %s" %((1==1))
and not (('testing' == 1) or (1 == 0)))
print("19. 'chunky'=='bacon'and not (3==4 or 3==4) = %s" %(('chunky'=='bacon')and not ((3==4)or(3==3))))
print("20. 3==3 and not('testing'=='testing' or python'=='Fun')=%s"%((3==3)and not
(('testing'=='testing')or ('python'=='Fun'))))
print("extra 1. 'tset' and 'test'= =%s" %'test'and'test')
